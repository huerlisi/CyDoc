ActionController::Routing::Routes.draw do |map|
  ...
  # Billing
  map.resources :invoices, :collection => {:print_all => :post, :print_all_reminders => :post}, :member => {:print => :post, :print_reminder => :post, :insurance_recipe => :get, :patient_letter => :get, :reminder => :get, :book => :post} do |invoice|
