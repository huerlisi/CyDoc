...
HonorificPrefix.create!([
  {:sex => 1, :name => 'Herr'},
  {:sex => 1, :name => 'Herr Dr.'},
  {:sex => 1, :name => 'Herr Dr. med.'},
  {:sex => 1, :name => 'Herr Prof.'},
  {:sex => 2, :name => 'Frau'},
  {:sex => 2, :name => 'Frau Dr.'},
  {:sex => 2, :name => 'Frau Dr. med.'},
  {:sex => 2, :name => 'Frau Prof.'}
])
...
user = User.create!(
  :name => "Demo Benützer", :login => "demo", :password => "demo1234", :password_confirmation => "demo1234", :email => "cydoc-demo@zytolabor.ch", :object => doctor
)
user.register!
user.activate!
...
doctor.accounts << Accounting::Account.create!([
  {:code => "3200", :title => "Debitoren"},
  {:code => "1000", :title => "Kasse"},
  {:code => "1100", :title => "Dienstleistungsertrag"},
])
